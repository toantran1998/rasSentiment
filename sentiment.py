...
class SentimentAnalyzer(Component):
    ...
    def train(self, training_data, cfg, **kwargs):
        ...
        print('tên biến training_data',type(training_data ))
        with open('labels.txt', 'r') as f:
            labels = f.read().splitlines()
        training_data = training_data.training_examples  # list of Message objects
        print('training 2',training_data)
        for t in training_data: print(t.get('tokens'))
    ...
    def persist(file_name, model_dir):
        ...
        utils.json_pickle(classifier_file)
